...
class TestAgentSpan:
    ...
    async def test_span_name_status_and_attributes(
        ...
        assert span.name == "invoke_agent oh-my-vibe"
        assert span.status.status_code == StatusCode.OK
        attrs = dict(span.attributes)
        assert attrs["gen_ai.operation.name"] == "invoke_agent"
        assert attrs["gen_ai.provider.name"] == "mistral_ai"
        assert attrs["gen_ai.agent.name"] == "oh-my-vibe"
...
class TestIntegration:
    ...
    async def test_agent_turn_with_tool_call_produces_spans(
        ...
        assert agent.name == "invoke_agent oh-my-vibe"
        ...
        assert agent_attrs["gen_ai.agent.name"] == "oh-my-vibe"
